...
from textwrap import dedent #This gets rid of the indents when we define our functions with """
...
class Death(Scene):
    ...
    #Different quips to be displayed upon death
    quips = [
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                blow up when it goes off.you die you see another Gothon frantically try to
                disarm the bomb. You die knowing they will probably
